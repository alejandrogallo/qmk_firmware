...
#define KC_DR2 KC_FN24
#define KC_DR1 KC_FN25
#define KC_DR0 KC_FN26
#define KC_DL2 KC_FN27
...
#define KC_DR0_ENT  MT(KC_DR0, KC_ENT)
...
#define LUAKH_MODIFIER_2 \
                   ___, LALT, LGUI, LCTL, ESC, /*|*/ BSPC, RCTL, RGUI, LALT, TAB
...
#define LUAKH_SYSTEM_1 \
              ___, ___, EXECUTE, ___, LTOG, /*|*/ A, ___, ___, ___, ___
